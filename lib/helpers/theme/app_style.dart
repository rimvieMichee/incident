...
import 'package:incident/helpers/my_widgets/my.dart';
import 'package:incident/helpers/my_widgets/my_breadcrumb_item.dart';
import 'package:incident/helpers/my_widgets/my_constant.dart';
...
class AppTheme {
  ...
  static ThemeData getThemeFromThemeMode() {
    ...
    return LocalStorage.getTheme() == "Dark" ? darkTheme : lightTheme;
  }
  ...
  static final ThemeData darkTheme = ThemeData.dark().copyWith(
    ...
    /// Scaffold and Background color
    scaffoldBackgroundColor: Color(0xff191410),
    canvasColor: Colors.transparent,
    splashFactory: NoSplash.splashFactory,
    ...
    /// AppBar Theme
    appBarTheme: AppBarTheme(backgroundColor: Color(0xff221A14).withOpacity(0.5),),
  ...
  static void initMyStyle() {
    ...
    My.setConstant(MyConstantData(
      ...
      defaultBreadCrumbItem:
          MyBreadcrumbItem(name: 'incident', route: '/dashboard'),
    ));
    bool isMobile = true;
    try {
