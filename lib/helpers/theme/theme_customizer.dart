...
import 'package:incident/helpers/localizations/translator.dart';
import 'package:incident/helpers/logger/logger.dart';
import 'package:incident/helpers/services/json_decoder.dart';
...
class ThemeCustomizer {
  ...
  static initLanguage() async {
    logD("LANGUAGE===${LocalStorage.getLanguage()}");
    if (LocalStorage.getLanguage() != null) {
      await changeLanguage(Language(Locale(LocalStorage.getLanguage() ?? ""),
